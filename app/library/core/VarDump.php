...
class VarDump
{
	 ...
	 *
	 * @param boolean $flushBuffer if set to false, ob_flush will not be called
	 * after echo
	 */
	 ...
	 * This is a wrapper for var_dump|xdebug_var_dump that adds
	 * the <pre /> tags, cleans up newlines and indents, adds file name and line
	 * number info
