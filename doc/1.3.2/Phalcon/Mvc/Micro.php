...
namespace Phalcon\Mvc
{
	 ...
	 * this, you only need to
	 * write a minimal amount of code to create a PHP application. Micro
	 ...
	 * </code>
	 */
	class Micro extends \Phalcon\DI\Injectable implements \Phalcon\Events\EventsAwareInterface, 
		\Phalcon\DI\InjectionAwareInterface, \ArrayAccess
	{
		...
		/**
		 * Sets a handler that will be called when the router doesn't match any
		...
		/**
		 * Check if a service is registered in the internal services container
		...
		/**
		 * Allows to register a shared service in the internal services
		 * container using the array syntax.
		...
		/**
		 * Removes a service from the internal services container using the
		 * array syntax
		 *
		 * @param string $alias
		...
		/**
		 * Appends a 'finish' middleware to be called when the request is
		 * finished
		 *
		 * @param callable $handler
		 * @return \Phalcon\Mvc\Micro
