...
namespace Phalcon\Mvc
{
	 ...
	 * That is, it exists to help keep the view script separate from the model
	 * and controller scripts.
	 ...
	 * </code>
	 */
	class View extends \Phalcon\DI\Injectable implements \Phalcon\Events\EventsAwareInterface, 
		\Phalcon\DI\InjectionAwareInterface, \Phalcon\Mvc\ViewInterface
	{
		 ...
		 * Must be a directory under the views directory. Depending of your
		 * platform, always add a trailing slash or backslash
		 *
		 * <code>
		...
		/**
		 * Choose a different view to render instead of
		 * last-controller/last-action
		 *
		 * <code>
		 ...
		 *
		 * <code>
		 * $template = $this->view->getRender('products', 'show',
