...
namespace Phalcon\Mvc
{
	 ...
	 * process of taking a URI endpoint (that part of the URI which comes after
	 * the base URL) and
	...
	class Router implements \Phalcon\Mvc\RouterInterface, \Phalcon\DI\InjectionAwareInterface
	{
		...
		/**
		 * Get rewrite info.
		 * This info is read from $_GET['_url']. This returns '/' if the rewrite
		...
		/**
		 * Set whether router must remove the extra slashes in the handled
		 * routes
		 *
		...
		/**
		 * Adds a route to the router that only match if the HTTP method is
		 * PATCH
		 *
		 * @param string $pattern
		 * @param string/array $paths
		...
		/**
		 * Add a route to the router that only match if the HTTP method is
		 * OPTIONS
		 *
		 * @param string $pattern
		 * @param string/array $paths
		...
		/**
		 * Set a group of paths to be returned when none of the defined routes
		 * are matched
		 *
