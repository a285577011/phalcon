...
namespace Phalcon\Mvc\View\Engine\Volt
{
	...
	class Compiler implements \Phalcon\DI\InjectionAwareInterface
	{
		...
		/**
		 * Return a unique prefix to be used as prefix for compiled variables
		 * and contexts
		 *
		 * @return string
		 */
		...
		/**
		 * Compiles a 'foreach' intermediate code representation into plain PHP
		 * code
		 *
		 ...
		 * This method does not return the compiled path if the template was not
		 * compiled
		 *
		 * <code>
		 * $compiler->compile('views/layouts/main.volt');
