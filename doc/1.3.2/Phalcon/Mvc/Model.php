...
namespace Phalcon\Mvc
{
	 ...
	 * Phalcon\Mvc\Model
	 *
	 * <p>Phalcon\Mvc\Model connects business objects and database tables to
	 * create
	 * a persistable domain model where logic and data are presented in one
	 * wrapping.
	 * It‘s an implementation of the object-relational mapping (ORM).</p>
	 *
	 * <p>A model represents the information (data) of the application and the
	 * rules to manipulate that data.
	 * Models are primarily used for managing the rules of interaction with a
	 * corresponding database table.
	 * In most cases, each table in your database will correspond to one model
	 * in your application.
	 * The bulk of your application’s business logic will be concentrated in the
	 * models.</p>
	 *
	 * <p>Phalcon\Mvc\Model is the first ORM written in C-language for PHP,
	 * giving to developers high performance
		...
		\Phalcon\DI\InjectionAwareInterface, \Serializable
	{
		...
		/**
		 * Sets the DependencyInjection connection service name used to read
		 * data
		 *
		 * @param string $connectionService
		 * @return \Phalcon\Mvc\Model
		...
		/**
		 * Sets the DependencyInjection connection service name used to write
		 * data
		 *
		 * @param string $connectionService
		 * @return \Phalcon\Mvc\Model
		...
		/**
		 * Returns the DependencyInjection connection service name used to read
		 * data related the model
		 *
		 * @return string
		 */
		...
		/**
		 * Returns one of the DIRTY_STATE_* constants telling if the record
		 ...
		 * $robot = Robots::findFirst(array("type='virtual'", "order" =>
		 * "name"));
		 ...
		 * $average = Robots::average(array("type='mechanical'", 'column' =>
		 * 'price'));
		 ...
		 * to verify that inserted/updated values are present in the related
		 * entity
		 *
		 * @return boolean
		 */
		...
		/**
		 * Sends a pre-build INSERT SQL statement to the relational database
		 * system
		 *
		 * @param \Phalcon\Mvc\Model\MetadataInterface $metaData
		 * @param \Phalcon\Db\AdapterInterface $connection
		...
		/**
		 * Sends a pre-build UPDATE SQL statement to the relational database
		 * system
		 *
		 * @param \Phalcon\Mvc\Model\MetadataInterface $metaData
		 * @param \Phalcon\Db\AdapterInterface $connection
		...
		/**
		 * Saves related records that must be stored prior to save the master
		 * record
		 *
		 * @param \Phalcon\Db\AdapterInterface $connection
		...
		/**
		 * Setup a relation n-n between two models through an intermediate
		 * relation
		 *
		 * <code>
		 *
		 ...
		 * This method is used internally to set snapshot data when the model
		...
		/**
		 * Sets if a model must use dynamic update instead of the all-field
		 * update
		 *
		 * <code>
		 *
		...
		/**
		 * Returns related records defined relations depending on the method
		 * name
		 *
		...
		/**
		 * Serializes the object ignoring connections, services, related objects
		 ...
		 * exceptionOnFailedSave — Enables/Disables throws an exception if the
		 * saving process fails
		 * phqlLiterals — Enables/Disables literals in PHQL this improves the
