...
namespace Phalcon\Mvc\Model
{
		...
		\Phalcon\Events\EventsAwareInterface
	{
		...
		/**
		 * Returns the connection service name used to read data related to a
		 * model
		 *
		 * @param \Phalcon\Mvc\ModelInterface $model
		 * @param string
		...
		/**
		 * Returns the connection service name used to write data related to a
		 * model
		 *
		 * @param \Phalcon\Mvc\ModelInterface $model
		 * @param string
		...
		/**
		 * Receives events generated in the models and dispatches them to a
		 * events-manager if available
		 ...
		 * This method expects that the endpoint listeners/behaviors returns
		 * true
		...
		/**
		 * Checks whether a model has a hasManyToMany relation with another
		 * model
		 *
		 * @param string $modelName
		 * @param string $modelRelation
