...
namespace Phalcon\Mvc\Model
{
	 ...
	 *
	 * <p>Because Phalcon\Mvc\Model requires meta-data like field names, data
	 * types, primary keys, etc.
	 * this component collect them and store for further querying by
	 * Phalcon\Mvc\Model.
	 * Phalcon\Mvc\Model\MetaData can also use adapters to store temporarily or
	 * permanently the meta-data.</p>
	 *
	 * <p>A standard Phalcon\Mvc\Model\MetaData can be used to query model
	 * attributes:</p>
	 *
	 * <code>
	...
	abstract class MetaData implements \Phalcon\DI\InjectionAwareInterface, \Phalcon\Mvc\Model\MetaDataInterface
	{
		 ...
		 *
		 * <code>
		 * print_r($metaData->writeColumnMapIndex(new Robots(),
		 * MetaData::MODELS_REVERSE_COLUMN_MAP, array('leName' => 'name')));
		 * </code>
		 *
		 * @param \Phalcon\Mvc\ModelInterface $model
		 * @param int $index
		...
		/**
		 * Returns attributes that must be ignored from the UPDATE SQL
		 * generation
		 *
		 * <code>
		 ...
		 *
		 * <code>
		 * $metaData->setAutomaticCreateAttributes(new Robots(),
		 * array('created_at' => true));
		 * </code>
		 *
		 * @param \Phalcon\Mvc\ModelInterface $model
		...
		/**
		 * Set the attributes that must be ignored from the UPDATE SQL
		 * generation
		 *
		 * <code>
		 * $metaData->setAutomaticUpdateAttributes(new Robots(),
		 * array('modified_at' => true));
		 * </code>
		 *
		 * @param \Phalcon\Mvc\ModelInterface $model
		 * @param array $attributes
