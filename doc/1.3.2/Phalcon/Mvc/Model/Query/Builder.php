...
namespace Phalcon\Mvc\Model\Query
{
	...
	class Builder implements \Phalcon\Mvc\Model\Query\BuilderInterface, \Phalcon\DI\InjectionAwareInterface
	{
		 ...
		 * ),
		 * ),
		 * // or 'conditions' => "created > '2013-01-01' AND created <
		 * '2014-01-01'",
		 * 'group' => array('id', 'name'),
		 * 'having' => "name = 'Kamil'",
		 * 'order' => array('name', 'id'),
		 ...
		 * $builder->where('name = :name: AND id > :id:', array('name' =>
		 * 'Peter', 'id' => 100));
		 * </code>
		 *
		 * @param string $conditions
		 ...
		 * $builder->andWhere('name = :name: AND id > :id:', array('name' =>
		 * 'Peter', 'id' => 100));
		 * </code>
		 *
		 * @param string $conditions
		 ...
		 * $builder->orWhere('name = :name: AND id > :id:', array('name' =>
		 * 'Peter', 'id' => 100));
		 * </code>
		 *
		 * @param string $conditions
