...
namespace Phalcon\Mvc\Model\Transaction
{
	...
	class Manager implements \Phalcon\Mvc\Model\Transaction\ManagerInterface, \Phalcon\DI\InjectionAwareInterface
	{
		...
		/**
		 * Set if the transaction manager must register a shutdown function to
		...
		/**
		 * Check if the transaction manager is registering a shutdown function
		 * to clean up pendent transactions
		 *
		 * @return boolean
		 */
		...
		/**
		 * Returns a new \Phalcon\Mvc\Model\Transaction or an already created
		 * once
		 * This method registers a shutdown function to rollback active
		 * connections
		 *
