...
namespace Phalcon\Mvc\Model\Resultset
{
	 ...
	 */
	class Simple extends \Phalcon\Mvc\Model\Resultset implements \Serializable, \ArrayAccess, \Countable, 
		\SeekableIterator, \Traversable, \Iterator, \Phalcon\Mvc\Model\ResultsetInterface
	{
		 ...
		 * number of rows
		 * it could consume more memory than it currently does.
		 * Exporting the resultset to an array
		...
		/**
		 * Unserializing a resultset only works on the rows present in the saved
		 * state
		 *
		 * @param string $data
		 */
