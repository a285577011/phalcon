...
namespace Phalcon\Mvc\Model
{
	 ...
	 * <code>
	 *
	 * $phql = "SELECT c.price*0.16 AS taxes, c.* FROM Cars AS c JOIN Brands AS
	 * b
	...
	class Query implements \Phalcon\Mvc\Model\QueryInterface, \Phalcon\DI\InjectionAwareInterface
	{
		...
		/**
		 * Replaces the model's name to its source name in a qualifed-name
		 * expression
		 *
		 * @param array $expr
		 * @return string
		...
		/**
		 * Processes the JOINs in the query returning an internal representation
		...
		/**
		 * Analyzes a SELECT intermediate code and produces an array to be
		 * executed later
		 *
		 * @return array
		 */
		...
		/**
		 * Analyzes an INSERT intermediate code and produces an array to be
		 * executed later
		 *
		 * @return array
		 */
		...
		/**
		 * Analyzes an UPDATE intermediate code and produces an array to be
		 * executed later
		 *
		 * @return array
		 */
		...
		/**
		 * Analyzes a DELETE intermediate code and produces an array to be
		 * executed later
		 *
		 * @return array
		 */
		...
		/**
		 * Parses the intermediate code produced by
		 * \Phalcon\Mvc\Model\Query\Lang generating another
		 * intermediate representation that could be executed by
		 * \Phalcon\Mvc\Model\Query
		 *
		 * @return array
		 */
