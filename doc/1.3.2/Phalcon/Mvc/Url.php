...
namespace Phalcon\Mvc
{
	 ...
	 * echo $url->get(array('for' => 'blog-post', 'title' => 'some-cool-stuff',
	 * 'year' => '2012'));
	 *
	 * </code>
	 */
	class Url implements \Phalcon\Mvc\UrlInterface, \Phalcon\DI\InjectionAwareInterface
	{
		 ...
		 *
		 * //Generate a URL for a predefined route
		 * echo $url->get(array('for' => 'blog-post', 'title' =>
		 * 'some-cool-stuff', 'year' => '2012'));
		 *
		 * </code>
		 *
		 * @param string|array $uri
		 * @param array|object args Optional arguments to be appended to the
		 * query string
