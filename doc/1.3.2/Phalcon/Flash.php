...
namespace Phalcon
{
	 ...
	 * Phalcon\Flash
	 *
	 * Shows HTML notifications related to different circumstances. Classes can
	 * be stylized using CSS
	 *
	 * <code>
	...
	abstract class Flash
	{
		...
		/**
		 * Set whether the output must be implictly flushed to the output or
		 * returned as string
		 *
