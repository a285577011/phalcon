...
namespace Phalcon
{
	 ...
	 * This component is an abstract class that you can extend to add more
	 * helpers.
	 */
	class Tag
	{
		 ...
		 *
		 * //Later in the view
		 * echo \Phalcon\Tag::textField("name"); //Will have the value "peter"
		 * by default
		 * </code>
		 *
		 * @param string $id
		...
		/**
		 * Check if a helper has a default value set using
		 * \Phalcon\Tag::setDefault or value from $_POST
		 *
		 * @param string $name
		 * @return boolean
		 */
		...
		/**
		 * Resets the request and internal values to avoid those fields will
		 ...
		 *
		 * <code>
		 * echo \Phalcon\Tag::numericField(array("price", "min" => "1", "max" =>
		 * "5"));
		 * </code>
		 *
		 * @param array $parameters
		 ...
		 *
		 * <code>
		 * echo \Phalcon\Tag::selectStatic("status", array("A" => "Active", "I"
		 * => "Inactive"))
		 * </code>
		 *
		 * @param array $parameters
		...
		/**
		 * Builds a HTML SELECT tag using a \Phalcon\Mvc\Model resultset as
		 * options
		 *
		 * <code>
		 ...
		 *
		 * <code>
		 * echo \Phalcon\Tag::textArea(array("comments", "cols" => 10, "rows" =>
		 * 4))
		 * </code>
		 *
		 * Volt syntax:
		 ...
		 * <code>
		 * echo
		 * \Phalcon\Tag::stylesheetLink("http://fonts.googleapis.com/css?family=Rosario",
		 * false);
		 ...
		 * Volt Syntax:
		 * <code>
		 * {{ stylesheet_link("http://fonts.googleapis.com/css?family=Rosario",
		 * false) }}
		 ...
		 * <code>
		 * echo
		 * \Phalcon\Tag::javascriptInclude("http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js",
		 * false);
		 ...
		 * <code>
		 * {{
		 * javascript_include("http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js",
		 * false) }}
		 ...
		 * echo \Phalcon\Tag::image(array("img/photo.jpg", "alt" => "Some
		 * Photo"));
		 * </code>
		 *
		 * Volt Syntax:
		 ...
		 *
		 * <code>
		 * echo \Phalcon\Tag::tagHtml($name, $parameters, $selfClose,
		 * $onlyStart, $eol);
		 * </code>
		 *
