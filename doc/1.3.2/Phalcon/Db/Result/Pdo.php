...
namespace Phalcon\Db\Result
{
	...
	class Pdo
	{
		...
		/**
		 * Allows to executes the statement again.
		 * Some database systems don't support scrollable cursors,
		 * So, as cursors are forward only, we need to execute the cursor again
		 * to fetch rows from the begining
		 *
		 * @return boolean
		 */
		...
		/**
		 * Fetches an array/object of strings that corresponds to the fetched
		...
		/**
		 * Moves internal resulset cursor to another position letting us to
		 * fetch a certain row
		 *
		 * <code>
		 * $result = $connection->query("SELECT * FROM robots ORDER BY name");
