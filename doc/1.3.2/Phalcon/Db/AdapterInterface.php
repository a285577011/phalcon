...
namespace Phalcon\Db
{
	...
	interface AdapterInterface
	{
		 ...
		 * state.
		 * Use this method only when the SQL statement sent to the server return
		 * rows
		 *
		 ...
		 * Sends SQL statements to the database server returning the success
		 * state.
		 * Use this method only when the SQL statement sent to the server don't
		 * return any row
		 *
		 * @param string $sqlStatement
		 * @param array $placeholders
		...
		/**
		 * Closes active connection returning success.
		 * \Phalcon automatically closes and destroys active connections within
		 * \Phalcon\Db\Pool
		 *
		 * @return boolean
		 */
		...
		/**
		 * Returns insert id for the auto_increment column inserted in the last
		 * SQL statement
		 *
		...
		/**
		 * Check whether the database system requires an explicit value for
		 * identity columns
		 *
		 * @return boolean
		 */
