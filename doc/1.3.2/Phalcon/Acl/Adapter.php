...
namespace Phalcon\Acl
{
	...
	abstract class Adapter implements \Phalcon\Events\EventsAwareInterface, \Phalcon\Acl\AdapterInterface
	{
		...
		/**
		 * Sets the default access level (Phalcon\Acl::ALLOW or
		 * \Phalcon\Acl::DENY)
		 *
		...
		/**
		 * Returns the role which the list is checking if it's allowed to
		 * certain resource/access
		 *
		 * @return string
		 */
		...
		/**
		 * Returns the resource which the list is checking if some role can
		 * access it
		 *
		 * @return string
		 */
		...
		/**
		 * Returns the access which the list is checking if some role can access
		 * it
		 *
		 * @return string
		 */
