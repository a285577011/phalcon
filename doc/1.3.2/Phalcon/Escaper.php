...
namespace Phalcon
{
	 ...
	 * Phalcon\Escaper
	 *
	 * Escapes different kinds of text securing them. By using this component
	 * you may
	 * prevent XSS attacks.
	 *
	 * This component only works with UTF-8. The PREG extension needs to be
	...
	class Escaper implements \Phalcon\EscaperInterface
	{
		 ...
		 * Special-handling for chr(172) and chr(128) to chr(159) which fail to
		 * be detected by mb_detect_encoding()
		 *
		 * @param string $str
		...
		/**
		 * Escape javascript strings by replacing non-alphanumeric chars by
		 * their hexadecimal escaped representation
		 *
		 * @param string $js
		 * @return string
		 */
