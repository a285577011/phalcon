...
namespace Phalcon
{
	 ...
	 * application space.
	 * By storing the value in a registry, the same object is always available
	 * throughout
	 * your application.
	 *
	 * <code>
	 ...
	 * using a foreach loop) interfaces. For PHP 5.4 and higher,
	 * JsonSerializable
	 ...
	 *
	 * Though Phalcon\Registry exposes methods like __get(), offsetGet(),
	 * count() etc,
	 * it is not recommended to invoke them manually (these methods exist mainly
	 * to
	 * match the interfaces the registry implements):
	 * $registry->__get('property')
