...
namespace Phalcon
{
	 ...
	 *
	 * Since Phalcon is highly decoupled, Phalcon\DI is essential to integrate
	 * the different
	 * components of the framework. The developer can also use this component to
	 * inject dependencies
	 * and manage global instances of the different classes used in the
	 * application.
	 *
	 * Basically, this component implements the `Inversion of Control` pattern.
	 * Applying this,
	 * the objects do not receive their dependencies using setters or
	 * constructors, but requesting
	 * a service dependency injector. This reduces the overall complexity, since
	 * there is only one
	 * way to get the required dependencies within a component.
	 *
	 * Additionally, this pattern increases testability in the code, thus making
	...
	class DI implements \Phalcon\DiInterface
	{
		...
		/**
		 * Resolves a service, the resolved service is stored in the DI,
		...
		/**
		 * Check whether the last service obtained via getShared produced a
		 * fresh instance or an existing one
		 *
		 * @return boolean
		 */
		...
		/**
		 * Set a default dependency injection container to be obtained into
		 * static methods
		 *
