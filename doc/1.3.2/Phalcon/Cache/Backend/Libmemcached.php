...
namespace Phalcon\Cache\Backend
{
	 ...
	 *
	 * Allows to cache output fragments, PHP data or raw data to a libmemcached
	 * backend
	 *
	 * This adapter uses the special memcached key "_PHCM" to store all the keys
	...
	class Libmemcached extends \Phalcon\Cache\Backend implements \Phalcon\Cache\BackendInterface
	{
		...
		/**
		 * Stores cached content into the Memcached backend and stops the
		 * frontend
		 *
		 * @param int|string $keyName
