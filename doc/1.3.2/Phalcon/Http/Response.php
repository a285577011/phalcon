...
namespace Phalcon\Http
{
	 ...
	 * Phalcon\HTTP\Response is the Phalcon component responsible to achieve
	 * this task.
	...
	class Response implements \Phalcon\Http\ResponseInterface, \Phalcon\DI\InjectionAwareInterface
	{
		 ...
		 * $response->redirect("http://www.example.com/new-location", true,
		 * 301);
		 *
		 ...
		 *
		 * @param string $content
		 * @param int $jsonOptions bitmask consisting on
