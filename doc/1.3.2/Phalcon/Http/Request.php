...
namespace Phalcon\Http
{
	 ...
	 *
	 * <p>Encapsulates request information for easy and secure access from
	 * application controllers.</p>
	 *
	 * <p>The request object is a simple value object that is passed between the
	...
	class Request implements \Phalcon\Http\RequestInterface, \Phalcon\DI\InjectionAwareInterface
	{
		 ...
		 * This method search in $_SERVER['REMOTE_ADDR'] and optionally in
		...
		/**
		 * Gets array with mime/types and their quality accepted by the
