...
class Stream extends Request
{
	...
	{
		$this->setOptions(
			array('user_agent'=> 'Phalcon HTTP/' . self::VERSION . ' (Stream)','follow_location'=> 1,
					'max_redirects'=> 20,'timeout'=> 30));
	}
	...
	public function get($uri, $params = array())
	{
		...
		$this->setOptions(array('method'=> 'GET','content'=> ''));
	...
	public function head($uri, $params = array())
	{
		...
		$this->setOptions(array('method'=> 'HEAD','content'=> ''));
	...
	public function delete($uri, $params = array())
	{
		...
		$this->setOptions(array('method'=> 'DELETE','content'=> ''));
