	...
	public static function register()
	{
		...
		set_error_handler(
			function ($errno, $errstr, $errfile, $errline)
			{
				...
				$options = array('type'=> $errno,'message'=> $errstr,'file'=> $errfile,'line'=> $errline,
						'isError'=> true);
		...
		set_exception_handler(
			...
			{
				$options = array('type'=> $e->getCode(),'message'=> $e->getMessage(),'file'=> $e->getFile(),
						'line'=> $e->getLine(),'isException'=> true,'exception'=> $e);
	...
	public static function handle(Error $error)
	{
		...
		switch($error->type())
		{
			...
			case E_RECOVERABLE_ERROR:
				...
				return $response->setContent($view->getContent())
					->send();
		}
	}
