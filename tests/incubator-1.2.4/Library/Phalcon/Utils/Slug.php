 ...
 * send you a copy immediately. | | | | The code below is inspired by Matteo
 * Spinelli's (cubiq.org) blog post | |
 * http://cubiq.org/the-perfect-php-clean-url-generator |
 * +------------------------------------------------------------------------+ |
 * Authors: Andres Gutierrez <andres@phalconphp.com> | | Nikolaos Dimopoulos
 * <nikos@niden.net> |
 * +------------------------------------------------------------------------+
 */
