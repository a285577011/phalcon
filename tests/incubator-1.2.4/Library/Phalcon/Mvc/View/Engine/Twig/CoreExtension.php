...
class CoreExtension extends \Twig_Extension
{
	...
	{
		$options = array('needs_environment'=> true,'pre_escape'=> 'html','is_safe'=> array('html'));
		
		return array('assetsOutputCss'=> new \Twig_Function_Method($this, 'functionAssetsOutputCss', $options),
	...
	{
		return array(new TokenParsers\Assets());
	}
